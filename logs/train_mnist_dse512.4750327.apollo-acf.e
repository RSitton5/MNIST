...
++ head -n 1 /var/spool/torque/aux//4750327.apollo-acf
...
Traceback (most recent call last):
  ...
  File "/lustre/haven/proj/UTK0150/envs/pytorch181/lib/python3.9/site-packages/torch/distributed/distributed_c10d.py", line 588, in _new_process_group_helper
    pg = ProcessGroupGloo(
RuntimeError: [enforce fail at ../third_party/gloo/gloo/transport/tcp/address.cc:30] sizeof(impl_) == bytes.size(). 136 vs 58
    pg = ProcessGroupGloo(
RuntimeError: [enforce fail at ../third_party/gloo/gloo/transport/tcp/address.cc:30] sizeof(impl_) == bytes.size(). 136 vs 58
    pg = ProcessGroupGloo(
RuntimeError: [enforce fail at ../third_party/gloo/gloo/transport/tcp/address.cc:30] sizeof(impl_) == bytes.size(). 136 vs 58
